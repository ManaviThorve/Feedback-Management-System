...
<h1><center>YES/NO-TRUE/False Question</center></h1><br>
<b><x style="color:#f1c40f;"></x></b><p>
	...
	<button name="next" value="next_textarea" type="submit" class="btn btn-success btn-block" style="background:#4FB9BA;" onclick="formCreated()">Skip</button>
</form>
<!---Form end--->
