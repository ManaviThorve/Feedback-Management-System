...
<!--Form start--->
<form class="form-container" action="GenerateForm.jsp" method="do">
<h1><center>Generate form</center></h1><br>
<b><x style="color:#f1c40f;"></x></b><p>
	<div class="form-group">
		<b><label for="email">Question:</label></b>
	...
	<h5>
	<h5><a href="AddQuestion.jsp"><b><x style="color:#f1c40f;"> Add Question</x></b></a></h5>
