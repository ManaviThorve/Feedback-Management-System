...
<!--Form start--->
<form class="form-container" action="AddFeedbackID.jsp" method="do">
<h1><center>Make a Feedback form</center></h1><br>
<b><x style="color:#f1c40f;"></x></b><p>
	...
	<h5><a href="ViewFeedback.jsp"><b><x style="color:#f1c40f;"> View Existing Feedback </x></b></a></h5>
</form>
<!---Form end--->
